"""
Generate populated generator_data_populated.csv from:
  - generator-data-baseline.xlsx  (PP names, existing technology, p_nom)
  - pp-fuel.xlsx                   (fuel mapping)
  - hardcoded marginal cost reference from artifact f62ef837

Run:
    python pipeline/generate_generator_data.py
"""
...
# 1. PATHS
# ---------------------------------------------------------------------------
BASELINE_PATH = Path("/root/.claude/uploads/69b3e8db-991a-5b4d-9ab0-953ed1ab9e27/8ad6887f-generatordatabaseline.xlsx")
FUEL_PATH     = Path("/root/.claude/uploads/69b3e8db-991a-5b4d-9ab0-953ed1ab9e27/322c2e71-ppfuel.xlsx")
OUT_CSV       = Path("pipeline/generator_data_populated.csv")
